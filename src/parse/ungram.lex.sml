...
fun yyAction16 (strm, lastMatch : yymatch) = (yystrm := strm;  Tok.Underscore)
...
fun yyAction32 (strm, lastMatch : yymatch) = (yystrm := strm;  Tok.AssocLeft)
fun yyAction33 (strm, lastMatch : yymatch) = (yystrm := strm;  Tok.AssocRight)
fun yyAction34 (strm, lastMatch : yymatch) = (yystrm := strm;  Tok.AssocNone)
fun yyAction35 (strm, lastMatch : yymatch) = (yystrm := strm;  Tok.RuleName)
fun yyAction36 (strm, lastMatch : yymatch) = (yystrm := strm;  Tok.Assoc)
fun yyAction37 (strm, lastMatch : yymatch) = (yystrm := strm;  Tok.Prec)
        ...
        | SOME(inp, strm') =>
            if inp = 0wx5B
              ...
              then if inp = 0wx3A
                  ...
                  then if inp <= 0wx2F
                      then yyAction38(strm, yyNO_MATCH)
                      else yyQ55(strm', yyMATCH(strm, yyAction38, yyNO_MATCH))
                else if inp <= 0wx40
                  then yyAction38(strm, yyNO_MATCH)
                  else yyQ55(strm', yyMATCH(strm, yyAction38, yyNO_MATCH))
            else if inp = 0wx60
        ...
        | SOME(inp, strm') =>
            if inp = 0wx5B
              ...
              then if inp = 0wx3A
                  ...
                  then if inp <= 0wx2F
                      then yyAction37(strm, yyNO_MATCH)
                      else yyQ55(strm', yyMATCH(strm, yyAction37, yyNO_MATCH))
                else if inp <= 0wx40
                  then yyAction37(strm, yyNO_MATCH)
                  else yyQ55(strm', yyMATCH(strm, yyAction37, yyNO_MATCH))
            else if inp = 0wx60
        ...
        | SOME(inp, strm') =>
            if inp = 0wx5B
              ...
              then if inp = 0wx3A
                  ...
                  then if inp <= 0wx2F
                      then yyAction34(strm, yyNO_MATCH)
                      else yyQ55(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
                else if inp <= 0wx40
                  then yyAction34(strm, yyNO_MATCH)
                  else yyQ55(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
            else if inp = 0wx60
        ...
        | SOME(inp, strm') =>
            if inp = 0wx5B
              ...
              then if inp = 0wx3A
                  ...
                  then if inp <= 0wx2F
                      then yyAction35(strm, yyNO_MATCH)
                      else yyQ55(strm', yyMATCH(strm, yyAction35, yyNO_MATCH))
                else if inp <= 0wx40
                  then yyAction35(strm, yyNO_MATCH)
                  else yyQ55(strm', yyMATCH(strm, yyAction35, yyNO_MATCH))
            else if inp = 0wx60
        ...
        | SOME(inp, strm') =>
            if inp = 0wx5B
              ...
              then if inp = 0wx3A
                  ...
                  then if inp <= 0wx2F
                      then yyAction32(strm, yyNO_MATCH)
                      else yyQ55(strm', yyMATCH(strm, yyAction32, yyNO_MATCH))
                else if inp <= 0wx40
                  then yyAction32(strm, yyNO_MATCH)
                  else yyQ55(strm', yyMATCH(strm, yyAction32, yyNO_MATCH))
            else if inp = 0wx60
        ...
        | SOME(inp, strm') =>
            if inp = 0wx5B
              ...
              then if inp = 0wx3A
                  ...
                  then if inp <= 0wx2F
                      then yyAction36(strm, yyNO_MATCH)
                      else yyQ55(strm', yyMATCH(strm, yyAction36, yyNO_MATCH))
                else if inp <= 0wx40
                  then yyAction36(strm, yyNO_MATCH)
                  else yyQ55(strm', yyMATCH(strm, yyAction36, yyNO_MATCH))
            else if inp = 0wx60
       ...
       of NONE => yyAction38(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx5F
              ...
              then yyQ72(strm', yyMATCH(strm, yyAction38, yyNO_MATCH))
            else if inp < 0wx73
              then if inp = 0wx60
                  then yyAction38(strm, yyNO_MATCH)
                  else yyQ55(strm', yyMATCH(strm, yyAction38, yyNO_MATCH))
       ...
       of NONE => yyAction39(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx2B
              ...
              then if inp = 0wx2A
                  then yyQ79(strm', yyMATCH(strm, yyAction39, yyNO_MATCH))
                  else yyAction39(strm, yyNO_MATCH)
            else if inp = 0wx2F
        ...
        | SOME(inp, strm') =>
            if inp = 0wxE
              ...
              then if inp = 0wx9
                  ...
                  else yyQ81(strm', yyMATCH(strm, yyAction0, yyNO_MATCH))
            else if inp = 0wx20
              then yyQ81(strm', yyMATCH(strm, yyAction0, yyNO_MATCH))
       ...
       of NONE => yyAction39(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx5D
              ...
              then yyQ28(strm', yyMATCH(strm, yyAction39, yyNO_MATCH))
              else yyAction39(strm, yyNO_MATCH)
      (* end case *))
            ...
            if inp = 0wxE
              ...
              then if inp = 0wxB
                  ...
                  then if inp = 0wxA
                      ...
                      else yyQ12(strm', yyMATCH(strm, yyAction30, yyNO_MATCH))
                else if inp = 0wxD
                  then yyAction30(strm, yyNO_MATCH)
                  else yyQ12(strm', yyMATCH(strm, yyAction30, yyNO_MATCH))
            else if inp = 0wx28
