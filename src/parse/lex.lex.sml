...
fun yyAction9 (strm, lastMatch : yymatch) = (yystrm := strm;  Tok.QUERY)
fun yyAction10 (strm, lastMatch : yymatch) = (yystrm := strm;  Tok.LP)
fun yyAction11 (strm, lastMatch : yymatch) = (yystrm := strm;  Tok.RP)
fun yyAction12 (strm, lastMatch : yymatch) = (yystrm := strm;  Tok.LB)
fun yyAction13 (strm, lastMatch : yymatch) = (yystrm := strm;  Tok.RB)
fun yyAction14 (strm, lastMatch : yymatch) = (yystrm := strm;  Tok.COMMA)
...
fun yyAction30 (strm, lastMatch : yymatch) = (yystrm := strm;  Tok.ASSOC_LEFT)
fun yyAction31 (strm, lastMatch : yymatch) = (yystrm := strm;  Tok.ASSOC_RIGHT)
fun yyAction32 (strm, lastMatch : yymatch) = (yystrm := strm;  Tok.ASSOC_NONE)
fun yyAction33 (strm, lastMatch : yymatch) = (yystrm := strm;  Tok.RULE_NAME)
fun yyAction34 (strm, lastMatch : yymatch) = (yystrm := strm;  Tok.KW_ASSOC)
fun yyAction35 (strm, lastMatch : yymatch) = (yystrm := strm;  Tok.KW_PREC)
       ...
       of NONE => yyAction28(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx60
              ...
              then if inp = 0wx5F
                  then yyQ77(strm', yyMATCH(strm, yyAction28, yyNO_MATCH))
       ...
       of NONE => yyAction37(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx28
              ...
              then if inp = 0wx27
                  then yyQ78(strm', yyMATCH(strm, yyAction37, yyNO_MATCH))
                  else yyAction37(strm, yyNO_MATCH)
            else if inp = 0wx5C
              then yyQ79(strm', yyMATCH(strm, yyAction37, yyNO_MATCH))
              else yyAction37(strm, yyNO_MATCH)
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = 0wx5B
              ...
              then if inp = 0wx3A
                  ...
                  then if inp <= 0wx2F
                      then yyAction36(strm, yyNO_MATCH)
                      else yyQ44(strm', yyMATCH(strm, yyAction36, yyNO_MATCH))
                else if inp <= 0wx40
                  then yyAction36(strm, yyNO_MATCH)
                  else yyQ44(strm', yyMATCH(strm, yyAction36, yyNO_MATCH))
            else if inp = 0wx60
        ...
        | SOME(inp, strm') =>
            if inp = 0wx5B
              ...
              then if inp = 0wx3A
                  ...
                  then if inp <= 0wx2F
                      then yyAction31(strm, yyNO_MATCH)
                      else yyQ44(strm', yyMATCH(strm, yyAction31, yyNO_MATCH))
                else if inp <= 0wx40
                  then yyAction31(strm, yyNO_MATCH)
                  else yyQ44(strm', yyMATCH(strm, yyAction31, yyNO_MATCH))
            else if inp = 0wx60
        ...
        | SOME(inp, strm') =>
            if inp = 0wx5B
              ...
              then if inp = 0wx3A
                  ...
                  then if inp <= 0wx2F
                      then yyAction35(strm, yyNO_MATCH)
                      else yyQ44(strm', yyMATCH(strm, yyAction35, yyNO_MATCH))
                else if inp <= 0wx40
                  then yyAction35(strm, yyNO_MATCH)
                  else yyQ44(strm', yyMATCH(strm, yyAction35, yyNO_MATCH))
            else if inp = 0wx60
        ...
        | SOME(inp, strm') =>
            if inp = 0wx5B
              ...
              then if inp = 0wx3A
                  ...
                  then if inp <= 0wx2F
                      then yyAction32(strm, yyNO_MATCH)
                      else yyQ44(strm', yyMATCH(strm, yyAction32, yyNO_MATCH))
                else if inp <= 0wx40
                  then yyAction32(strm, yyNO_MATCH)
                  else yyQ44(strm', yyMATCH(strm, yyAction32, yyNO_MATCH))
            else if inp = 0wx60
        ...
        | SOME(inp, strm') =>
            if inp = 0wx5B
              ...
              then if inp = 0wx3A
                  ...
                  then if inp <= 0wx2F
                      then yyAction33(strm, yyNO_MATCH)
                      else yyQ44(strm', yyMATCH(strm, yyAction33, yyNO_MATCH))
                else if inp <= 0wx40
                  then yyAction33(strm, yyNO_MATCH)
                  else yyQ44(strm', yyMATCH(strm, yyAction33, yyNO_MATCH))
            else if inp = 0wx60
        ...
        | SOME(inp, strm') =>
            if inp = 0wx5B
              ...
              then if inp = 0wx3A
                  ...
                  then if inp <= 0wx2F
                      then yyAction30(strm, yyNO_MATCH)
                      else yyQ44(strm', yyMATCH(strm, yyAction30, yyNO_MATCH))
                else if inp <= 0wx40
                  then yyAction30(strm, yyNO_MATCH)
                  else yyQ44(strm', yyMATCH(strm, yyAction30, yyNO_MATCH))
            else if inp = 0wx60
        ...
        | SOME(inp, strm') =>
            if inp = 0wxE
              ...
              then if inp = 0wx9
                  ...
                  else yyQ70(strm', yyMATCH(strm, yyAction0, yyNO_MATCH))
            else if inp = 0wx20
              then yyQ70(strm', yyMATCH(strm, yyAction0, yyNO_MATCH))
              else yyAction0(strm, yyNO_MATCH)
      (* end case *))
and yyQ70 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction0(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wxE
              then yyAction0(strm, yyNO_MATCH)
       ...
       of NONE => yyAction37(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx5D
              ...
              then if inp = 0wx6E
                  then yyQ18(strm', yyMATCH(strm, yyAction37, yyNO_MATCH))
                  else yyAction37(strm, yyNO_MATCH)
            else if inp = 0wx74
              then yyQ19(strm', yyMATCH(strm, yyAction37, yyNO_MATCH))
              else yyAction37(strm, yyNO_MATCH)
      (* end case *))
            ...
            if inp = 0wxE
              ...
              then if inp = 0wxB
                  ...
                  then if inp = 0wxA
                      ...
                      else yyQ21(strm', yyMATCH(strm, yyAction22, yyNO_MATCH))
                else if inp = 0wxD
                  then yyAction22(strm, yyNO_MATCH)
                  else yyQ21(strm', yyMATCH(strm, yyAction22, yyNO_MATCH))
            else if inp = 0wx23
...
in
  (case (!(yyss))
   of COM => yyQ0(!(yystrm), yyNO_MATCH)
    ...
    | SQSTRING => yyQ3(!(yystrm), yyNO_MATCH)
  (* end case *))
end
end
